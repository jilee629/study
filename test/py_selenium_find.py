...
driver.find_element(By.CSS_SELECTOR, 'input[placeholder="아이디를 입력해 주세요."]')
...
driver.find_element(By.XPATH, '//*[@id="root"]/main/div/article/aside/section/div[3]/button[2]/div/strong')
